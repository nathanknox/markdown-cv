...
- Apache Spark, Scala, Python, technical architecture, functional programming, organization change management

## Selected Experience
`2019-Present`
__Databricks__ - _Lead Specialist Solutions Architect_
  - Design, build, and optimize enterprise-scale data applications and platforms for high-performance organizations on all 3 public hyperscalers (AWS, Azure, GCP).
  ...
  - Founder and co-author of the Databricks Security Reference Architecture project, leveraging Terraform to help customers scale from zero to production in days instead of months.
...
- Top 5 US Pharmacy/Retailer - _Data Engineer_
  - Leveraged Databricks and Spark to modernize the organization's retail personalization program.
  - Designed and built pipelines for consumer-facing personalization engine to drive sales and increase margin.
  - Elictited business requirements to facilitate technical runway.
...
- Top 5 US Healthcare Payor - _Tech Lead_
  - Wrote code and architected solutions as the team's primary developer to meet product owner and business requirements.
  - Supplied technical leadership for two development teams, one onshore and one offshore.
